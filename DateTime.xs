...
/* It seems that on Windows before Perl 5.20, the Perl_isfinite macro exists,
   but it tries to call Perl_isinf and Perl_isnan, which don't exist. */
#if defined (Perl_isfinite) && defined (Perl_isinf) && defined (Perl_isnan)
#  define dt_isfinite Perl_isfinite
#else
#  include <math.h>
#  ifdef isfinite
#    define dt_isfinite isfinite
#  else
#    ifdef finite
#      define dt_isfinite finite
#    endif
#  endif
#endif
